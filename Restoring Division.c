...
int main() {
    int N;
    N = 10;
    int dividend[8] = {1, 1, 0, 1, 0, 1, 0, 1}; // Binary representation of dividend (example)
    int divisor[8] = {1, 0, 1, 1, 0, 0, 1, 0};  // Binary representation of divisor (example)
    int quotient[8]; // Quotient will be of the same size as the dividend
